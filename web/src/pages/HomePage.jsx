...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Momento M�gicos - Detalles con amor para momentos especiales</title>
        <meta name="description" content="Encuentra el regalo perfecto en Momento M�gicos. Osos de peluche, regalos personalizados y detalles únicos para expresar tu amor." />
      </Helmet>
